 ...
 */
public class UttamI18nInterceptor extends AbstractInterceptor {

	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = 1451730953556691919L;

	/** The Constant LOG. */
	protected static final Logger LOG = LogManager.getLogger(UttamI18nInterceptor.class);
	...
	public String intercept(ActionInvocation invocation) throws Exception {
		...
		LOG.debug("Locale set in Context Provider: {}", locale);
