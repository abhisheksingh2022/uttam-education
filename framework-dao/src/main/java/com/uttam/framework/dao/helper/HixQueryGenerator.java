package com.uttam.framework.dao.helper;
...
public class HixQueryGenerator {
	...
	public static String generateQuery(@SuppressWarnings("rawtypes") Class aClass, String[] returnProperty,
		...
		if (propertyNames != null) {
			for (int i = 0; i < propertyNames.length; i++) {
				...
				if (propertyValues != null && propertyValues[i] instanceof String
						&& propertyValues[i].toString().contains("%")) {
