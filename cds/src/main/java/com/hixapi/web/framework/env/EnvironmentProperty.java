...
public class EnvironmentProperty implements java.io.Serializable {
    ...
    /**
         ...
         *                the create date
         */
    public EnvironmentProperty(String propertyCd, String propertyValue, String providerId) {
    ...
    /**
         ...
         *                the modify date
         */
    public EnvironmentProperty(String propertyCd, String propertyValue,
	String propertyDesc, Date createDate, Date modifyDate) {
	this.code = propertyCd;
	this.value = propertyValue;
