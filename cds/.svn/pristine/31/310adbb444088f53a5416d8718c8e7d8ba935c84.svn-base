 ...
 * 
 * @change - Javascript escape was removed to avoid escaping apostrophe and other user entered characters. The parameters are
 *         still trimmed off leading and trailing spaces.
 * @author admin Oct 7, 2009
 * @change - Specific script tags will be stripped in this change. See the <code>SanitizerUtil.sanitizeTags</code> method
 * 
 */
